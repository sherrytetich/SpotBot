...
<div class="bg-art-small">
    ...
    <div class="bg-art-quote">
        ...
        <span><mark>Our free and confidential helpline is available on 911. </mark></span> <br>
        <span><mark> We are here to help you if you need support.  </mark></span><br>
    ...
    <div class="contact-page">
        <div class="contact-page-options">
            <div class="contact-page-ct1">
                ...
                <br><br><br><br><a href="#"><button>Call or text 911  <i class='bx bxs-chevron-right' ></i></button></a>
            </div>
            <div class="contact-page-ct1">
                <div id="bar-new"></div><br>
        ...
        <div class="offices">
            ...
            <span>Spotbot</span><br>
            <span>Kabarak,Nakuru</span><br><br>
            <span>Tel: 0798151516</span><br>
        </div>
    </div>
</div>
